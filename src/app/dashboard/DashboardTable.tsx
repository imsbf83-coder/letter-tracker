        ...
        <table className="w-full text-sm">
          <thead className="bg-paper-raised text-left text-ink-soft text-xs uppercase tracking-wide">
            <tr>
              ...
              <th className="px-4 py-2 font-medium">Sent by</th>
          ...
          <tbody>
            {letters.map((letter) => (
              ...
              >
                ...
                <td className="px-4 py-3">{letter.sentBy || "—"}</td>
                ...
                <td className="px-4 py-3">
                  <button
                    ...
                    name="singleId"
                    value={letter.id}
                    className="bg-ink text-paper text-xs font-medium rounded-sm px-3 py-1.5 hover:bg-ink-soft transition-colors"
                  >
                    Mark
                  </button>
                </td>
